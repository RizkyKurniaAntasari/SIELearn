    ...
    <aside class="w-64 bg-purple-700 text-white min-h-screen p-6 flex flex-col justify-between">
        ...
        <div>
            ...
            <nav class="space-y-4 text-lg">
                ...
                <a href="{{ route('admin.tugas.index') }}" class="block py-2 px-3 hover:bg-purple-800 rounded">
                    <i class="fa fa-list-check mr-2"></i> Tugas
                </a>

                <a href="{{ route('admin.absensi.index') }}" class="block py-2 px-3 hover:bg-purple-800 rounded">
                    <i class="fa fa-calendar-check mr-2"></i> Absensi
                </a>
                ...
                <a href="{{ route('admin.pembayaran.index') }}" class="block py-2 px-3 hover:bg-purple-800 rounded">
                    <i class="fa fa-money-bail mr-2"></i> Pembayaran
                </a>
        ...
        <form action="{{ route('admin.logout') }}" method="POST">
            @csrf
            <button class="bg-red-500 hover:bg-red-600 w-full py-3 rounded-lg text-white font-semibold mt-10">
