...
@section('main-content')
    <div class="flex flex-col md:flex-row justify-between items-end mb-8">
        ...
        <div class="text-right hidden md:block">
            {{-- Updated to Purple to match sidebar theme --}}
            <span class="block text-4xl font-bold text-purple-600">30</span>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-8">
            ...
            <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 relative overflow-hidden group">
                ...
                <div class="relative z-10">
                    ...
                    <form action="#" method="POST">
                        @csrf
                        {{-- Keep Green for Positive Action (Confirm Attendance) --}}
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100 flex justify-between items-center">
                    ...
                    <button class="text-sm text-purple-600 hover:underline">Lihat Semua</button>
                </div>
        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-1 gap-4">
                ...
                {{-- Changed to Purple to match primary theme --}}
                <div class="bg-purple-50 rounded-2xl p-6 flex flex-col justify-between h-32 hover:shadow-md transition border border-purple-100">
                    <div class="p-2 bg-purple-100 w-fit rounded-lg">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-purple-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                        </svg>
                    </div>
                    <div>
                        <span class="text-3xl font-bold text-purple-900">85%</span>
                        <p class="text-xs font-semibold text-purple-700 uppercase mt-1">Kehadiran</p>
                    </div>
                </div>

                {{-- CARD 2: Total Present --}}
                {{-- Changed to Blue for a harmonious cool tone next to purple --}}
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                ...
                <div class="space-y-4">
                    {{-- Item 1: Sakit --}}
                    {{-- Changed to Blue to represent neutral info/sick --}}
                    <div class="flex items-center gap-3">
                     ...
                     {{-- Item 2: Izin --}}
                     {{-- Changed to Amber/Yellow to match 'Izin' status badge --}}
                    <div class="flex items-center gap-3">
                     ...
                     {{-- Item 3: Alfa --}}
                     {{-- Changed to Red to match 'Alfa' status badge --}}
                    <div class="flex items-center gap-3">
