...
@section('main-content')
    <div class="bg-gradient-to-r from-indigo-600 to-blue-500 rounded-2xl p-6 mb-8 text-white shadow-lg relative overflow-hidden">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-8">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                ...
                <div class="relative pl-4 border-l-2 border-gray-200 space-y-8">
                    <div class="relative pl-4 group">
                        <div class="absolute -left-[21px] top-1 bg-blue-500 h-4 w-4 rounded-full border-4 border-white shadow-sm group-hover:scale-125 transition duration-300"></div>
                        <div class="flex justify-between items-start">
                            <div>
                                <p class="font-semibold text-gray-800">Dosen menambahkan materi baru</p>
                                <p class="text-sm text-blue-600 font-medium bg-blue-50 inline-block px-2 py-0.5 rounded mt-1">Modul 3: Laravel Eloquent</p>
                            </div>
                    ...
                    <div class="relative pl-4 group">
                        <div class="absolute -left-[21px] top-1 bg-purple-500 h-4 w-4 rounded-full border-4 border-white shadow-sm group-hover:scale-125 transition duration-300"></div>
                        <div class="flex justify-between items-start">
                            <div>
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="{{ route('mahasiswa.tugas') }}" class="text-sm font-semibold text-indigo-600 hover:text-indigo-800 hover:underline">Lihat Semua</a>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="border border-gray-200 rounded-xl p-4 hover:shadow-lg hover:border-blue-300 transition duration-300 group">
                        <div class="flex justify-between items-start mb-2">
                            <span class="px-2 py-1 text-[10px] font-bold uppercase tracking-wide rounded bg-red-100 text-red-600">
                                Deadline: 3 Nov
                            </span>
                        </div>
                        <a href="#" class="block text-lg font-bold text-gray-800 group-hover:text-blue-600 mb-2">Tugas 2: CRUD Laravel</a>
                    ...
                    <div class="border border-gray-200 rounded-xl p-4 hover:shadow-lg hover:border-yellow-300 transition duration-300 group">
                        <div class="flex justify-between items-start mb-2">
                            <span class="px-2 py-1 text-[10px] font-bold uppercase tracking-wide rounded bg-yellow-100 text-yellow-700">
                                Deadline: 7 Nov
                            </span>
                        </div>
                        <a href="#" class="block text-lg font-bold text-gray-800 group-hover:text-blue-600 mb-2">Kuis 2: Blade</a>
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden">
                ...
                <a href="{{ route('mahasiswa.absensi') }}" class="block w-full py-2.5 text-center text-sm font-semibold text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 hover:border-gray-400 transition">
                    Lihat Riwayat Absen
                </a>
            </div>
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                ...
                <div class="bg-blue-50 rounded-xl p-4 mb-4 border border-blue-100">
                    <div class="flex items-start">
                        <svg class="w-8 h-8 text-blue-500 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path d="M9 2a2 2 0 00-2 2v8a2 2 0 002 2h6a2 2 0 002-2V6.414A2 2 0 0016.414 5L14 2.586A2 2 0 0012.586 2H9z"></path><path d="M3 8a2 2 0 012-2v10h8a2 2 0 01-2 2H5a2 2 0 01-2-2V8z"></path></svg>
                        <div>
                ...
                <a href="#" class="flex items-center justify-center w-full px-4 py-2.5 bg-indigo-600 text-white font-semibold text-sm rounded-xl shadow-md shadow-indigo-200 hover:bg-indigo-700 hover:shadow-lg transition">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                ...
                <div class="flex items-center space-x-4 mb-4">
                    <div class="relative">
                        <img class="h-14 w-14 rounded-full border-2 border-indigo-100 object-cover" src="https://i.pravatar.cc/150?img=11" alt="Foto Dosen">
                        <div class="absolute bottom-0 right-0 w-3 h-3 bg-green-500 rounded-full border-2 border-white"></div>
                    </div>
                    <div>
                        <p class="font-bold text-gray-900 text-sm">M. Iqbal Parabi, S.SI., M.T.</p>
                        <a href="mailto:iqbal.parabi@unila.ac.id" class="text-xs text-indigo-500 hover:underline">iqbal.parabi@unila.ac.id</a>
                    </div>
                </div>
                <a href="{{ route('mahasiswa.forum') }}" class="flex items-center justify-center w-full py-2.5 text-sm font-semibold text-indigo-600 bg-indigo-50 rounded-lg hover:bg-indigo-100 transition">
