...
@section('main-content')
    ...
    <div class="mb-6">
        ...
        <select id="kelas" name="kelas" 
            class="mt-1 block w-full max-w-xs pl-3 pr-10 py-2 text-base 
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap font-bold text-green-600">92.5</td>
                </tr>
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap font-bold text-yellow-600">82.5</td>
                </tr>
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">90</td>
                    <td class="px-6 py-4 whitespace-nowrap">90</td>
                    <td class="px-6 py-4 whitespace-nowrap font-bold text-green-600">90.0</td>
                </tr>
