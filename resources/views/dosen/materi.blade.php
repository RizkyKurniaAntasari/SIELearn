    ...
    <div class="bg-white p-6 rounded-xl shadow-lg border border-purple-100">
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-purple-50">
                <tr>
                    <th class="px-6 py-3 text-left text-xs font-bold text-purple-700 tracking-wider uppercase">Judul</th>
                    <th class="px-6 py-3 text-left text-xs font-bold text-purple-700 tracking-wider uppercase">Deskripsi</th>
                    <th class="px-6 py-3 text-left text-xs font-bold text-purple-700 tracking-wider uppercase">File</th>
                    <th class="px-6 py-3 text-left text-xs font-bold text-purple-700 tracking-wider uppercase">Aksi</th>
                </tr>
            </thead>
            
            <tbody class="bg-white divide-y divide-gray-200">
                <tr class="hover:bg-purple-50 transition duration-150">
                    <td class="px-6 py-4 font-medium text-gray-700">Modul 1: ERD & Migrations</td>
                    <td class="px-6 py-4 text-gray-600">Pengenalan database...</td>
